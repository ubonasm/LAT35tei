...
if not st.session_state.data.empty:
    ...
    with tab2:
        ...
        if relations:
            ...
            # ノードラベルの描画
            nx.draw_networkx_labels(G, pos, labels=nx.get_node_attributes(G, 'label'), font_family='Hiragino Maru Gothic Pro', 'Yu Gothic', 'Meirio', 'Takao', 'IPAexGothic', 'IPAPGothic', 'VL PGothic', 'Noto Sans CJK JP')
            ...
            nx.draw_networkx_edge_labels(G, pos, edge_labels=edge_labels, font_family='Hiragino Maru Gothic Pro', 'Yu Gothic', 'Meirio', 'Takao', 'IPAexGothic', 'IPAPGothic', 'VL PGothic', 'Noto Sans CJK JP')
